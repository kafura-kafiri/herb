...
class FaceCV(object):
    ...
    """
    CASE_PATH = os.path.dirname(os.path.realpath(__file__)) + "/pretrained_models/haarcascade_frontalface_alt.xml"
    ...
    def __init__(self, depth=16, width=8, face_size=64):
        ...
        model_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), "pretrained_models").replace("//", "\\")
